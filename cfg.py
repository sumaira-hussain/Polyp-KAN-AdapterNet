...
def parse_args():    
    ...
    parser.add_argument('-net', type=str, default='polyp_kan', help='net type')
    ...
    parser.add_argument('-exp_name', default='polyp_kan', type=str, help='net type')
    parser.add_argument('-type', type=str, default='map', help='condition type:ave,rand,rand_map')
    parser.add_argument('-vis', type=int, default=10, help='visualization')
    # parser.add_argument('-vis', action='store_true', help='Enable visualization during training')
    ...
    parser.add_argument('-dataset', default='Kvasir' ,type=str,help='dataset name')
